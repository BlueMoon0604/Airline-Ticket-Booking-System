    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/flights/search/round-trip").permitAll()

                        .requestMatchers(HttpMethod.POST, "/flights/**")
                        .hasAnyRole("ADMIN", "AIRLINE_STAFF")

                        .requestMatchers(HttpMethod.PUT, "/flights/*/decrement-seats")
                        .hasAnyRole("ADMIN", "AIRLINE_STAFF", "PASSENGER")

                        .requestMatchers(HttpMethod.PUT, "/flights/*/increment-seats")
                        .hasAnyRole("ADMIN", "AIRLINE_STAFF", "PASSENGER")
